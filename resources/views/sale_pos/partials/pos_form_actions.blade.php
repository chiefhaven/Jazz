...
<div class="row">
    <div
        ...
        <div
                ...
                @if (!$is_mobile)
                    ...
                    <div class="pos-total md:tw-flex md:tw-items-center md:tw-gap-3 tw-hidden">
                        <div
                            ...
                            <div>@lang('sale.total')    @lang('lang_v1.payable'):</div>
                        </div>
                        <input type="hidden" name="final_total" id="final_total_input" value="0.00">
            ...
            <div class="tw-w-full md:tw-w-fit tw-flex tw-flex-col tw-items-end tw-gap-3 tw-hidden md:tw-block">
                <a href="{{ route('logout') }}"
                    class="tw-font-bold tw-bg-red-600 hover:tw-bg-red-700 active:tw-bg-red-800 tw-transition tw-duration-200 tw-rounded-full tw-text-white tw-w-full md:tw-w-fit tw-px-5 tw-h-15 tw-flex tw-items-center tw-justify-center tw-cursor-pointer tw-text-lg md:tw-text-lg">
