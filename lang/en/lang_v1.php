...
return [
    ...
    'get_latest_config' => 'Get latest config',
    ...
    'submitting_bills' => 'Submitting Bills to EIS',
    'bills_submitted_successfully' => 'Bills submitted to EIS successfully',
    'no_unsubmitted_bills_found' => 'No unsubmitted bills found',
    'unsubmitted_bills_found' => 'Unsubmitted bills found',
    'total_unsubmitted_bills' => 'Total Unsubmitted Bills',
    'you_are_about_to_submit_all_bills' => 'You are about to submit all bills',
    'yes_submit_all' => 'Yes, Submit All',
    'checking' => 'Checking',
    'processing' => 'Processing',
    'submit_to_eis' => 'Submit to EIS',
    'eis_submission' => 'EIS Submission',
    'eis_offline' => 'EIS is currently offline. Please try again later.',
    'eis_health_check' => 'Checking EIS health...',
    'eis_online' => 'EIS is online',
    'eis_offline_error' => 'Cannot submit sales now, EIS is offline',
    'eis_config_incomplete' => 'EIS configuration is incomplete. Please check settings.',
    'eis_disabled' => 'EIS is disabled for this business',
    'eis_submission_initiated' => 'EIS submission process initiated',
    'eis_submission_failed' => 'EIS submission failed',
    'eis_batch_processing' => 'Processing bills in batches...',
    'eis_batch_completed' => 'All bills processed successfully',
    'eis_batch_failed' => 'Some bills failed to process',
    'eis_invoice_no' => 'EIS Invoice Number',
    'eis_submitted_at' => 'Submitted At',
    'eis_pending' => 'Pending',
    'eis_submitted' => 'Submitted',
    'eis_failed' => 'Failed',
    'eis_retry' => 'Retry Submission',
    'eis_view_details' => 'View EIS Details',
    'eis_no_records' => 'No EIS records found',
    'eis_submission_summary' => 'EIS Submission Summary',
    'eis_total_submitted' => 'Total Submitted',
    'eis_total_pending' => 'Total Pending',
    'eis_total_failed' => 'Total Failed',
    'eis_submit_all_confirmation' => 'You are about to submit :count bills to EIS',
    'eis_processing_please_wait' => 'Please wait while bills are being submitted...',
    'eis_submission_in_background' => 'Bills are being submitted in the background. You will be notified when completed.',
    ...
    'cannot_split_after_eis_submission' => 'Cannot split bill after EIS submission',
    'sell_line_not_found' => 'Selected product line not found',
    'quantity_must_be_greater_than_zero' => 'Quantity must be greater than zero',
    'quantity_exceeds_available' => 'Quantity exceeds available (:available)',
    'cannot_split_combo_product_quantity' => 'Cannot split combo product quantity partially',
    'split_quantity' => 'Split Quantity',
    'enter_split_quantity' => 'Enter quantity to split',
    'transaction_number' => 'Transaction Number',
    'card_transaction_number' => 'Card transaction No',
    'cannot_split_all_items' => 'Cannot split all items. Original invoice must maintain at least 1 item.',
    ...
    'activate_eis_terminal' => 'Activate EIS',
    'eis_terminal_activated_successfully' => 'EIS Terminal activated successfully',
    'deactivate_eis_terminal' => 'Deactivate EIS Terminal',
    'eis_terminal_deactivated_successfully' => 'EIS Terminal deactivated successfully',
    'terminal_activation_code' => 'Terminal activation code',
    ...
    'clear_all_bills' => 'Clear All Bills',
    'confirm_clear_all_bills' => 'Confirm Clear All Bills',
    'you_are_about_to_clear_all_unpaid_bills' => 'You are about to clear all unpaid bills. This action will mark all unpaid invoices as paid.',
    'total_unpaid_invoices' => 'Total Unpaid Invoices',
    'total_due_amount' => 'Total Due Amount',
    'cancel' => 'Cancel',
    'are_you_sure' => 'Are you sure',
    'yes_clear_all' => 'Yes clear all',
    'no_unpaid_bills_found' => 'No unpaid bills found to clear.',
    'bills_cleared_successfully' => 'Successfully cleared :count bill(s) totaling :amount.',
    'bulk_payment_cleared' => 'Bulk payment cleared',
    'confirmation_required' => 'Confirmation required to proceed',
    'bulk_payment_cleared_by_user' => 'Bulk payment cleared by user',
    'add_note_for_bulk_payment' => 'Add note for bulk payment',
